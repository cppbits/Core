#ifndef BIT_CORE_MEMORY_DETAIL_EXCLUSIVE_PTR_INL
#define BIT_CORE_MEMORY_DETAIL_EXCLUSIVE_PTR_INL
...
private:
  ...
  ::bit::core::compressed_tuple<T, Allocator> m_storage;
};

template<typename T, typename Allocator>
template<typename...Args>
inline bit::core::detail::exclusive_ptr_emplace<T,Allocator>
  ::exclusive_ptr_emplace( Allocator alloc, Args&&...args )
...
template<typename T, typename Allocator>
inline void bit::core::detail::exclusive_ptr_emplace<T,Allocator>::destroy()
{
...
template<typename T, typename Allocator>
inline void* bit::core::detail::exclusive_ptr_emplace<T,Allocator>
...
template<typename T, typename Allocator>
inline T* bit::core::detail::exclusive_ptr_emplace<T,Allocator>::get()
  noexcept
{
  using bit::core::get;

  return std::addressof(bit::core::get<0>(m_storage));
}
...
template<typename T, typename Deleter, typename Allocator>
inline bit::core::detail::exclusive_ptr_pointer<T,Deleter,Allocator>
  ::exclusive_ptr_pointer( T* pointer,
                           const Deleter& deleter,
                           const Allocator& allocator )
  : m_storage( std::piecewise_construct,
...
template<typename T, typename Deleter, typename Allocator>
inline void bit::core::detail::exclusive_ptr_pointer<T,Deleter,Allocator>
  ::destroy()
{
...
template<typename T, typename Deleter, typename Allocator>
inline T* bit::core::detail::exclusive_ptr_pointer<T,Deleter,Allocator>::get()
  noexcept
{
  using bit::core::get;
...
inline bit::core::exclusive_ptr<T>
  bit::core::detail::static_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::detail::dynamic_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::detail::const_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::detail::reinterpret_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T>
inline constexpr bit::core::exclusive_ptr<T>::exclusive_ptr()
  noexcept
...
template<typename T>
inline constexpr bit::core::exclusive_ptr<T>::exclusive_ptr( std::nullptr_t )
  noexcept
...
inline bit::core::exclusive_ptr<T>::exclusive_ptr( Y* ptr, Deleter deleter )
...
template<typename T>
inline bit::core::exclusive_ptr<T>::exclusive_ptr( exclusive_ptr&& other )
  noexcept
...
template<typename T>
template<typename Y, typename>
inline bit::core::exclusive_ptr<T>::exclusive_ptr( exclusive_ptr<Y>&& other )
  noexcept
  : m_control_block( other.m_control_block ),
    m_ptr( other.m_ptr )
{
...
template<typename T>
inline bit::core::exclusive_ptr<T>::~exclusive_ptr()
{
  reset();
}
...
template<typename T>
bit::core::exclusive_ptr<T>&
  bit::core::exclusive_ptr<T>::operator=( exclusive_ptr&& other )
  noexcept
{
...
template<typename Y, typename>
bit::core::exclusive_ptr<T>&
  bit::core::exclusive_ptr<T>::operator=( exclusive_ptr<Y>&& other )
  noexcept
{
  if( m_control_block ) m_control_block->destroy();
...
template<typename T>
bit::core::exclusive_ptr<T>&
  bit::core::exclusive_ptr<T>::operator=( std::nullptr_t other )
  noexcept
{
  reset();
...
template<typename T>
inline void bit::core::exclusive_ptr<T>::reset()
  noexcept
{
  if( m_control_block ) {
...
template<typename T>
template<typename Y, typename Deleter, typename>
inline void bit::core::exclusive_ptr<T>::reset( Y* ptr, Deleter deleter )
{
...
template<typename T>
inline void bit::core::exclusive_ptr<T>::swap( exclusive_ptr& other )
  noexcept
{
  using std::swap;
...
template<typename T>
inline typename bit::core::exclusive_ptr<T>::element_type*
  bit::core::exclusive_ptr<T>::get()
  const noexcept
{
  return m_ptr;
}
...
inline std::add_lvalue_reference_t<typename bit::core::exclusive_ptr<T>::element_type>
  bit::core::exclusive_ptr<T>::operator[]( std::ptrdiff_t i )
  noexcept
{
  return m_ptr[i];
}
...
template<typename T>
inline std::add_lvalue_reference_t<typename bit::core::exclusive_ptr<T>::element_type>
  bit::core::exclusive_ptr<T>::operator*()
  const noexcept
{
  return (*m_ptr);
}
...
template<typename T>
inline bit::core::exclusive_ptr<T>::operator bool()
  const noexcept
{
...
template<typename T>
inline bit::core::exclusive_ptr<T>::exclusive_ptr( ctor_tag,
...
template<typename T>
inline bool bit::core::operator==( const exclusive_ptr<T>& lhs,
...
template<typename T>
inline bool bit::core::operator==( std::nullptr_t,
                                  const exclusive_ptr<T>& rhs )
  noexcept
{
...
template<typename T>
inline void bit::core::swap( exclusive_ptr<T>& lhs, exclusive_ptr<T>& rhs )
  noexcept
{
  lhs.swap(rhs);
}
...
template<typename T>
inline bit::core::hash_t bit::core::hash_value( const exclusive_ptr<T>& val )
  noexcept
{
...
inline Deleter* bit::core::get_deleter( const exclusive_ptr<T>& ptr )
{
...
inline bit::core::exclusive_ptr<T> bit::core::make_exclusive( Args&&...args )
{
...
inline bit::core::exclusive_ptr<T>
  bit::core::allocate_exclusive( const Allocator& alloc,
                                Args&&...args )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::casts::static_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::casts::dynamic_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::casts::const_pointer_cast( exclusive_ptr<U>&& other )
{
...
template<typename T, typename U>
inline bit::core::exclusive_ptr<T>
  bit::core::casts::reinterpret_pointer_cast( exclusive_ptr<U>&& other )
{
  return detail::reinterpret_pointer_cast<T>( std::move(other) );
}

#endif //BIT_CORE_MEMORY_DETAIL_EXCLUSIVE_PTR_INL
