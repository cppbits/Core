#ifndef BIT_CORE_UTILITIES_DETAIL_VARIANT_INL
#define BIT_CORE_UTILITIES_DETAIL_VARIANT_INL
...
inline constexpr bit::core::variant<Types...>
...
template<typename...Types>
inline bit::core::variant<Types...>
  ::variant( enable_overload_if_t<is_copy_constructible,const variant&> other )
  noexcept( bit::core::conjunction<std::is_nothrow_copy_constructible<Types>...>::value )
{
...
inline bit::core::variant<Types...>
  ...
  noexcept( bit::core::conjunction<std::is_nothrow_move_constructible<Types>...>::value )
{
...
inline constexpr bit::core::variant<Types...>::variant( T&& t )
  noexcept( std::is_nothrow_constructible<typename bit::core::variant<Types...>::template T_j<T>,T>::value )
...
template<typename...Types>
inline bit::core::variant<Types...>&
  bit::core::variant<Types...>::operator=( enable_overload_if_t<is_copy_assignable,const variant&> other )
{
...
template<typename...Types>
inline bit::core::variant<Types...>&
  bit::core::variant<Types...>::operator=( enable_overload_if_t<is_move_assignable,variant&&> other )
    noexcept( bit::core::conjunction<std::is_nothrow_move_constructible<Types>...,
...
template<typename T, typename>
inline bit::core::variant<Types...>&
  bit::core::variant<Types...>::operator=(T&& t)
  noexcept( std::is_nothrow_assignable<typename bit::core::variant<Types...>::template T_j<T>,T>::value &&
            std::is_nothrow_constructible<typename bit::core::variant<Types...>::template T_j<T>,T>::value )
{
...
template<typename...Types>
inline constexpr std::size_t bit::core::variant<Types...>::index()
  const noexcept
{
...
template<typename...Types>
inline constexpr bool bit::core::variant<Types...>::valueless_by_exception()
  const noexcept
{
...
template<typename...Types>
template<typename T, typename...Args, typename>
inline T& bit::core::variant<Types...>::emplace( Args&&...args )
{
...
template<typename...Types>
template<typename T, typename U, typename...Args, typename>
inline T& bit::core::variant<Types...>::emplace( std::initializer_list<U> il,
                                                Args&&...args )
{
  using index = detail::index_from<T,Types...>;
...
template<typename...Types>
template<std::size_t I, typename... Args, typename>
inline bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::variant<Types...>::emplace( Args&&... args )
{
...
template<std::size_t I, typename U, typename... Args, typename>
inline bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::variant<Types...>::emplace( std::initializer_list<U> il,
                                        Args&&... args )
{
  static_assert(I<sizeof...(Types), "");
...
template<typename...Types>
inline void bit::core::variant<Types...>::swap( variant& rhs )
{
...
inline constexpr bit::core::variant_alternative_t<I,bit::core::variant<Types...>>&
  bit::core::variant<Types...>::get( in_place_index_t<I> )
  noexcept
{
...
template<typename...Types>
template<std::size_t I>
inline constexpr const bit::core::variant_alternative_t<I,bit::core::variant<Types...>>&
  bit::core::variant<Types...>::get( in_place_index_t<I> )
  const noexcept
{
  return base_type::get( in_place_index<I> );
...
inline void bit::core::variant<Types...>
...
inline void bit::core::variant<Types...>::static_assign( T&& value )
{
...
inline bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::variant<Types...>::static_emplace( in_place_index_t<N>,
...
inline bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::variant<Types...>::static_emplace( in_place_index_t<0>,
                                               union_type<Ts...>& storage,
                                               Args&&...args )
{
...
template<typename...Types>
inline constexpr bool bit::core::operator==( const variant<Types...>& lhs,
                                            const variant<Types...>& rhs )
  noexcept
{
...
constexpr bool bit::core::holds_alternative( const variant<Types...>& v )
  noexcept
{
...
constexpr bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::get( variant<Types...>& v )
{
...
template<std::size_t I, typename...Types>
constexpr const bit::core::variant_alternative_t<I, bit::core::variant<Types...>>&
  bit::core::get( const variant<Types...>& v )
{
  static_assert( (I < sizeof...(Types)), "I is not a valid index into the variant" );
...
template<typename T, typename...Types>
constexpr T& bit::core::get( variant<Types...>& v )
{
...
template<typename T, typename...Types>
constexpr const T& bit::core::get( const variant<Types...>& v )
{
  return get<detail::index_from<T,Types...>::value>(v);
}
...
template<std::size_t I, typename...Types>
constexpr std::add_pointer_t<bit::core::variant_alternative_t<I, bit::core::variant<Types...>>>
  bit::core::get_if( variant<Types...>* pv )
  noexcept
{
  static_assert( (I < sizeof...(Types)), "I is not a valid index into the variant" );
...
template<std::size_t I, typename...Types>
constexpr std::add_pointer_t<const bit::core::variant_alternative_t<I, bit::core::variant<Types...>>>
  bit::core::get_if( const variant<Types...>* pv )
  noexcept
{
  static_assert( (I < sizeof...(Types)), "I is not a valid index into the variant" );
...
template<typename T, typename...Types>
constexpr std::add_pointer_t<T> bit::core::get_if( variant<Types...>* pv )
  noexcept
{
...
template<typename T, typename...Types>
constexpr std::add_pointer_t<const T> bit::core::get_if( const variant<Types...>* pv )
  noexcept
{
  return get_if<detail::index_from<T,Types...>::value>( pv );
}
...
template<typename...Types>
inline constexpr bit::core::hash_t bit::core::hash_value( const variant<Types...>& val )
  noexcept
{
...
#endif /* BIT_CORE_UTILITIES_DETAIL_VARIANT_INL */
