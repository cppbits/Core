#ifndef BIT_CORE_UTILITIES_DETAIL_COMPRESSED_TUPLE_INL
#define BIT_CORE_UTILITIES_DETAIL_COMPRESSED_TUPLE_INL
...
inline constexpr bit::core::detail::compressed_tuple_storage<Idx,T,true>
...
template<std::size_t Idx, typename T>
inline constexpr T& bit::core::detail::compressed_tuple_storage<Idx,T,true>
...
template<std::size_t Idx, typename T>
inline constexpr const T& bit::core::detail::compressed_tuple_storage<Idx,T,true>
...
template<std::size_t Idx, typename T>
template<typename U>
inline void bit::core::detail::compressed_tuple_storage<Idx,T,true>
...
template<std::size_t Idx, typename T>
template<typename Tuple, std::size_t...Idxs>
inline constexpr bit::core::detail::compressed_tuple_storage<Idx,T,false>
  ::compressed_tuple_storage( std::piecewise_construct_t,
                              Tuple&& tuple,
                              std::index_sequence<Idxs...> )
...
template<std::size_t Idx, typename T>
inline constexpr T& bit::core::detail::compressed_tuple_storage<Idx,T,false>
  ::do_get( size_constant<Idx> ) &
{
...
template<std::size_t Idx, typename T>
inline constexpr const T& bit::core::detail::compressed_tuple_storage<Idx,T,false>
  ::do_get( size_constant<Idx> ) const &
{
...
template<std::size_t Idx, typename T>
template<typename U>
inline void bit::core::detail::compressed_tuple_storage<Idx,T,false>
  ::do_assign( size_constant<Idx>, U&& val )
{
...
inline constexpr bit::core::detail::compressed_tuple_impl<Idx,T0,Ts...>
...
template<std::size_t Idx, typename T0, typename...Ts>
inline constexpr void bit::core::detail::compressed_tuple_impl<Idx,T0,Ts...>
...
template<std::size_t Idx, typename T0, typename...Ts>
template<typename Arg0, typename...Args>
inline void bit::core::detail::compressed_tuple_impl<Idx,T0,Ts...>
...
inline constexpr bit::core::detail::compressed_tuple_impl<Idx>
  ::compressed_tuple_impl( in_place_t )
{
...
template<std::size_t Idx>
inline void bit::core::detail::compressed_tuple_impl<Idx>
  ::do_get( size_constant<Idx> )
  noexcept
{
  // nothing to get
...
template<std::size_t Idx>
inline constexpr void bit::core::detail::compressed_tuple_impl<Idx>
...
inline constexpr bit::core::compressed_tuple<Types...>
...
template<typename...Types>
template<typename... UTypes>
inline bit::core::compressed_tuple<Types...>& bit::core::compressed_tuple<Types...>
...
template<typename...Types>
template<typename Tuple, std::size_t...Idxs>
inline void bit::core::compressed_tuple<Types...>
...
template<typename...Types>
inline constexpr void bit::core::compressed_tuple<Types...>
...
template<typename...Types>
inline constexpr bool bit::core::operator==( const compressed_tuple<Types...>& lhs,
...
template<typename...Types>
inline constexpr void bit::core::swap( compressed_tuple<Types...>& lhs,
...
template<typename...Args>
inline constexpr bit::core::compressed_tuple<std::decay_t<Args>...>
  bit::core::make_compressed_tuple( Args&&...args )
{
  using result_type = bit::core::compressed_tuple<std::decay_t<Args>...>;
...
inline constexpr bit::core::tuple_element_t<I,bit::core::compressed_tuple<UTypes...>>&
  bit::core::get( compressed_tuple<UTypes...>& tuple )
  noexcept
{
...
template<std::size_t I, typename...UTypes>
inline constexpr const bit::core::tuple_element_t<I,bit::core::compressed_tuple<UTypes...>>&
  bit::core::get( const compressed_tuple<UTypes...>& tuple )
  noexcept
{
  return tuple.do_get( size_constant<I>{} );
}
...
//inline constexpr bit::core::tuple_element<bit::core::index_of_type<T,Types...>::value,bit::core::compressed_tuple<Types...>>&
//  bit::core::get( compressed_tuple<Types...>& tuple )
//  noexcept
//{
...
//
//template<typename T, typename...Types>
//inline constexpr const bit::core::tuple_element<bit::core::index_of_type<T,Types...>::value,bit::core::compressed_tuple<Types...>>&
//  bit::core::get( const compressed_tuple<Types...>& tuple )
//  noexcept
//{
//  static constexpr auto index = index_of_type<T,Types...>::value;
//
...
#endif /* BIT_CORE_UTILITIES_DETAIL_COMPRESSED_TUPLE_INL */
