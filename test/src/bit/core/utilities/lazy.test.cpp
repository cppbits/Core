/*****************************************************************************
 * \file
 * \brief Test cases for bit::core::lazy
 *****************************************************************************/
...
TEST_CASE("bit::core::lazy()", "[ctor]")
{
  bit::core::lazy<std::string> lazy;
...
TEST_CASE("bit::core::lazy( const lazy& )", "[ctor]")
{
  bit::core::lazy<std::string> lazy( bit::core::in_place, "Hello World" );
...
TEST_CASE("bit::core::lazy( lazy&& )", "[ctor]")
{
  bit::core::lazy<std::string> lazy = "Hello World";
...
TEST_CASE("bit::core::lazy( const lazy<U>& )", "[ctor]")
{
  bit::core::lazy<const char*> lazy = "Hello World";

  SECTION("Copy constructs an uninitialized lazy")
  {
    bit::core::lazy<std::string> copy(lazy);
...
TEST_CASE("bit::core::lazy( lazy<U>&& )", "[ctor]")
{
  bit::core::lazy<const char*> lazy = "Hello World";

  SECTION("Move constructs an uninitialized lazy")
  {
    bit::core::lazy<std::string> move(std::move(lazy));
...
TEST_CASE("bit::core::lazy( U&& )", "[ctor]")
{
  bit::core::lazy<int> lazy = 3.5;
...
TEST_CASE("bit::core::lazy( in_place_t, Args&&...args )", "[ctor]")
{
  bit::core::lazy<std::string> lazy( bit::core::in_place, "Hello World", 5 );
...
TEST_CASE("bit::core::lazy::operator=( const lazy& )", "[assignment]")
{
  bit::core::lazy<std::string> source = "Hello World";
  bit::core::lazy<std::string> destination = "Goodbye World";
...
TEST_CASE("bit::core::lazy::operator=( lazy&& )", "[assignment]")
{
  const char* string = "Hello World";
  bit::core::lazy<std::string> source = string;
  bit::core::lazy<std::string> destination = "Goodbye World";
...
TEST_CASE("bit::core::lazy::operator=( const lazy<U>& )", "[assignment]")
{
  bit::core::lazy<const char*> source = "Hello World";
  bit::core::lazy<std::string> destination = "Goodbye World";
...
TEST_CASE("bit::core::lazy::operator=( lazy<U>&& )", "[assignment]")
{
  const char* string = "Hello World";
  bit::core::lazy<const char*> source = string;
  bit::core::lazy<std::string> destination = "Goodbye World";
...
TEST_CASE("bit::core::lazy::operator=( U&& )", "[assignment]")
{
  const char* string = "Hello World";
  bit::core::lazy<std::string> lazy;
...
TEST_CASE("bit::core::lazy::initialize()", "[modifiers]")
{
  bit::core::lazy<int> lazy = 42;
...
TEST_CASE("bit::core::lazy::reset()", "[modifiers]")
{
   bit::core::lazy<int> lazy = 42;
...
TEST_CASE("bit::core::lazy::swap( lazy& )", "[modifiers]")
{
  int left_value  = 0xdead;
  int right_value = 0xbeef;
  bit::core::lazy<int> left  = left_value;
  bit::core::lazy<int> right = right_value;
...
TEST_CASE("bit::core::lazy::operator bool")
{
  bit::core::lazy<int> lazy;
...
TEST_CASE("bit::core::lazy::has_value")
{
  bit::core::lazy<int> lazy;
...
TEST_CASE("bit::core::lazy::value() &")
{
  int value = 42;
  bit::core::lazy<int> lazy = value;
...
TEST_CASE("bit::core::lazy::value() const &")
{
  int value = 42;
  const bit::core::lazy<int> lazy = value;
...
TEST_CASE("bit::core::lazy::value_or( U&& ) const &")
{
  const bit::core::lazy<int> lazy = 42;
...
TEST_CASE("bit::core::lazy::value_or( U&& ) &&")
{
  bit::core::lazy<int> lazy = 42;
...
TEST_CASE("bit::core::make_lazy<T>( Args&&... )", "[utility]")
{
  auto lazy = bit::core::make_lazy<std::string>("Hello World", 5);
...
TEST_CASE("bit::core::make_lazy_generator<T>( Ctor&& )", "[utility]")
{
  auto lazy = bit::core::make_lazy_generator<int>([](){ return std::make_tuple( 42 ); });
