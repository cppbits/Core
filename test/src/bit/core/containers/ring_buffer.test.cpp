/*****************************************************************************
 * \file
 * \brief Unit tests for ring_buffer
 *****************************************************************************/

#include <bit/core/containers/ring_buffer.hpp>

#include <bit/core/utilities/aligned_storage.hpp> // aligned_storage_for
...
TEST_CASE("ring_buffer::ring_buffer()", "[ctor]")
{
  auto empty = bit::core::ring_buffer<int>{};

  SECTION("Constructs null ring buffer")
  {
...
TEST_CASE("ring_buffer::ring_buffer( std::nullptr_t )", "[ctor]")
{
  auto empty = bit::core::ring_buffer<int>{nullptr};
...
TEST_CASE("ring_buffer::ring_buffer( void*, size_type )", "[ctor]")
{
  using storage_type = bit::core::aligned_storage_for<int[5]>;

  const auto size = 5u;
  auto storage = storage_type{};
  auto data = reinterpret_cast<char*>(&storage);
  auto buffer = bit::core::ring_buffer<int>(data,size);
...
TEST_CASE("ring_buffer::push_back( const T& )","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<copyable[5]>;
  ...
  auto storage = storage_type{};
  auto data = reinterpret_cast<char*>(&storage);
  auto buffer = bit::core::ring_buffer<copyable>(data,size);
...
TEST_CASE("ring_buffer::push_back( T&& )","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<moveable[5]>;
  ...
  auto storage = storage_type{};
  auto data = reinterpret_cast<char*>(&storage);
  auto buffer = bit::core::ring_buffer<moveable>(data,size);
...
TEST_CASE("ring_buffer::push_front( const T& )","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<copyable[5]>;
...
TEST_CASE("ring_buffer::push_front( T&& )","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<moveable[5]>;
...
TEST_CASE("ring_buffer::emplace_back( Args&&... )", "[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<copyable[5]>;
...
TEST_CASE("ring_buffer::emplace_front( Args&&... )", "[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<copyable[5]>;
...
TEST_CASE("ring_buffer::pop_back()","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<int[5]>;
...
TEST_CASE("ring_buffer::pop_front()","[modifier]")
{
  using storage_type = bit::core::aligned_storage_for<int[5]>;
