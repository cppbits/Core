/*****************************************************************************
 * \file
 * \brief Unit tests for bit::core::basic_string_view
 *****************************************************************************/
...
TEST_CASE("string_view::string_view( const char* )","[ctor]")
{
  ...
  {
    bit::core::string_view view = empty_str;
...
{
  bit::core::string_view empty = "";
  bit::core::string_view view  = "Hello world";
...
TEST_CASE("string_view::swap( string_view& )","[modifier]")
{
  ...
  bit::core::string_view view1 = str1;
  bit::core::string_view view2 = str2;
...
TEST_CASE("string_view::compare( string_view )","[comparison]")
{
  ...
  {
    bit::core::string_view view = "Hello";
  ...
  {
    bit::core::string_view view = "1234567";
...
TEST_CASE("string_view::operator==(...)","[comparison]")
{
  ...
  SECTION("Is equal")
  {
    ...
    {
      bit::core::string_view view2 = "Hello World";
  ...
  SECTION("Is not equal")
  {
    ...
    {
      bit::core::string_view view2 = "Goodbye World";
