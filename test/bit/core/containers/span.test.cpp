...
{
  int array[] = {1,2,3,4,5};
  auto view   = bit::core::span<int>(array,5);
...
{
  int array[] = {1,2,3,4,5};
  auto view   = bit::core::span<int>(array);
...
TEST_CASE("span::span( const span<T,M>& )", "[ctor]")
{
  ...
  {
    auto view2 = bit::core::span<int>(view);
  ...
  {
    auto view2 = bit::core::span<int,5>(view);
...
TEST_CASE("span::span( span<T,M>&& )", "[ctor]")
{
  ...
  SECTION("Constructs an unbounded view from another view")
  {
    auto view2 = bit::core::span<int>(std::move(view));
  ...
  SECTION("Constructs a bounded view from another view")
  {
    auto view2 = bit::core::span<int,5>(std::move(view));
...
TEST_CASE("span::span( const std::vector& )", "[ctor]")
{
  ...
  auto view   = bit::core::span<int>(vector);
...
{
  auto string = bit::core::string_view("Hello");
  auto view   = bit::core::span<const char>(string);
