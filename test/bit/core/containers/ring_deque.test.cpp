/*****************************************************************************
 * \file
 * \brief Unit tests for the ring_deque
 *****************************************************************************/
...
TEST_CASE("ring_deque::ring_deque()", "[ctor]")
{
  bit::core::ring_deque<int> empty;

  SECTION("Constructs null ring deque")
  {
...
TEST_CASE("ring_deque::ring_deque( const Allocator& )", "[ctor]")
{
  // TODO(bitwizeshift): Test copying an allocator. Requires custom allocator
}

TEST_CASE("ring_deque::ring_deque( size_type, const T&, const Allocator& )", "[ctor]")
{
...
TEST_CASE("ring_deque::ring_deque( size_type, const Allocator& )", "[ctor]")
{
  SECTION("Doesn't specify allocator")
  {
...
TEST_CASE("ring_deque::ring_deque( const ring_deque& )", "[ctor]")
{
  bit::core::ring_deque<int> original{5};
  for( auto i = 0; i < 5; ++i ) {
...
TEST_CASE("ring_deque::ring_deque( const ring_deque&, const Allocator& )", "[ctor]")
{
  // TODO(bitwizeshift): Test copying an allocator. Requires custom allocator
}

TEST_CASE("ring_deque::ring_deque( ring_deque&& )", "[ctor]")
{
  bit::core::ring_deque<moveable> original{5};
  for( auto i = 0; i < 5; ++i ) {
    original.emplace_back(i);
  }
...
TEST_CASE("ring_deque::ring_deque( ring_deque&&, const Allocator& )", "[ctor]")
{
  // TODO(bitwizeshift): Test copying an allocator. Requires custom allocator
}
...
TEST_CASE("ring_deque::operator=( ring_deque )", "[assignment]")
{
  auto deque = bit::core::ring_deque<nothrow_moveable>{10};
...
TEST_CASE("ring_deque::push_back( const T& )","[modifier]")
{
  const auto size = 5u;
  const copyable entry{42};
  auto deque = bit::core::ring_deque<copyable>{size};
...
TEST_CASE("ring_deque::push_back( T&& )","[modifier]")
{
  const auto size = 5u;
  moveable entry{42};
  auto deque = bit::core::ring_deque<moveable>{size};
...
TEST_CASE("ring_deque::push_front( const T& )","[modifier]")
{
  const auto size = 5u;
  const copyable entry{42};
  auto deque = bit::core::ring_deque<copyable>{size};
...
TEST_CASE("ring_deque::push_front( T&& )","[modifier]")
{
  const auto size = 5u;
  moveable entry{42};
  auto deque = bit::core::ring_deque<moveable>{size};
...
TEST_CASE("ring_deque::emplace_back( Args&&... )", "[modifier]")
{
  const auto size = 5u;
  auto deque = bit::core::ring_deque<copyable>{size};
  const auto value = 42;
...
TEST_CASE("ring_deque::emplace_front( Args&&... )", "[modifier]")
{
  const auto size = 5u;
  auto deque = bit::core::ring_deque<copyable>{size};
  const auto value = 42;
...
TEST_CASE("ring_deque::pop_back()","[modifier]")
{
  const auto size = 5u;
  auto deque = bit::core::ring_deque<int>{size};
...
TEST_CASE("ring_deque::pop_front()","[modifier]")
{
  const auto size = 5u;
  auto deque = bit::core::ring_deque<int>{size};
...
TEST_CASE("ring_deque::swap( ring_deque& )","[modifier]")
{
  const auto size = 5u;
  auto right = bit::core::ring_deque<moveable>{};
  auto left = bit::core::ring_deque<moveable>{size};
...
TEST_CASE("ring_deque::resize( size_type )", "[modifier]")
{
  SECTION("Deque is empty")
  {
    ...
    SECTION("New size bigger than current capacity")
    {
      ...
      auto deque = bit::core::ring_deque<int>{};
  ...
  SECTION("Deque is not empty")
  {
    SECTION("New size bigger than current capacity")
    {
      SECTION("T is nothrow move constructible")
      {
        ...
        auto deque = bit::core::ring_deque<nothrow_moveable>{size};
